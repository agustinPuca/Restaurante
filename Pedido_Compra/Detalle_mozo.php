 ...
 <div class="container col-11 my-3 ">
     <div class=" text-center">
			<div class="table-responsive">
                    <a href="update_Detalle.php?idPedido_Compra=<? echo $idPedido_Compra; ?>" class="btn btn-primary  float-right" >Modificar o Eliminar</a> 
                    <br>
                    <br>
                    <nav class="navbar navbar-light justify-content-between " style="background-color:rgb(108,059,042)">
											<h4><a href="index_mozo.php"><i class="fas fa-list text-white "></i></a></h4>
