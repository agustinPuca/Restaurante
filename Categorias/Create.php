	...
	if(isset($_POST["insertar"])) //dicha función comprueba si una variable está definida o no en el script de PHP que se está ejecutando
				{
					...
					while(true)
					{
									...
									$sql="insert into categoria_menu(Nombre_cat_menu,Descripcion_cat_menu,Fecha_Alta) values(?,?,NOW())";
...
<div class="todo container col-11">
						...
						<table class="table bg-light" id="tabla">
									<thead  class="text-center text-white" style="background-color:rgb(108,059,042)" >
										<th colspan="1"><h4><a href="index.php"class="titulo3create" ><i class="fas fa-list text-white "></i></a></h4></th>
											<th colspan="2" ><h4 class="titulo4create">Agregar Categoria</h4></th>
									</thead >
									<thead  class="text-center" >
										...
										<div class="btn-der ">
											<input type="submit" name="insertar" value="Insertar Categoria" class="btn btn-info"/>
